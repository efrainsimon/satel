          ...
          <h1 className="font-semibold text-2xl pb-5 border-b" id="tituloFactura">Factura</h1>
          {
            ...
            <>
              <div className="border-b">
                ...
                <div className="pt-2"><span className="font-bold">Ruc:</span> 1724304802001</div>
                ...
                <div className="pb-5"><span className="font-bold">Email:</span> satelnetpc@hotmail.com</div>
              </div>
              <div className="border-b">
          ...
          <div className="border-t">
            <div className="flex flex-col my-3">
              <div className="flex font-semibold justify-between text-sm uppercase">
                <span>Subtotal</span>
                <span>${productsPrice ? parseFloat(productsPrice - (productsPrice * 0.10714)).toFixed(2) : 0}</span>
              </div>
              <div className="flex font-semibold justify-between text-sm uppercase">
                <span>IVA 12%</span>
                <span>${productsPrice ? parseFloat(productsPrice * 0.10714).toFixed(2) : 0}</span>
              </div>
              <div className="flex font-semibold justify-between text-sm uppercase">
                <span>Total</span>
                <span>${parseFloat(productsPrice).toFixed(2)}</span>
              </div>
              {
                <div className="flex font-semibold justify-between text-sm uppercase">
                  <span>Ahorraste</span>
